      ...
      <div className="container mx-auto px-8 py-12 max-w-7xl">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-6 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-slate-600 text-sm">{item.member.plan}</div>
                    </div>
        ...
        <div className="bg-white border border-slate-200 shadow-sm rounded-xl p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div className="bg-slate-50 border border-green-500/40 rounded-lg p-6">
              <div className="text-slate-600 text-sm mb-2">月間売上増加額</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-slate-50 border border-green-500/40 rounded-lg p-6">
              <div className="text-slate-600 text-sm mb-2">防衛可能売上</div>
              <div className="text-4xl font-bold text-green-700">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-6 flex-1">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-slate-500 text-xs mt-1">年間リスク売上</div>
                    </div>
                  </div>
                </div>
        ...
        <div className="text-center mt-12">
          <div className="flex justify-center gap-4">
            <Link
              href="/stores"
              className="px-6 py-3 bg-slate-100 hover:bg-slate-200 rounded-lg text-slate-900 transition-colors"
            >
              店舗一覧を見る
            </Link>
            <Link
