  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="mb-6 flex items-center justify-between gap-4">
        <div>
          <TrainerListBackLink className="text-blue-700 hover:text-blue-800 hover:underline text-sm mb-2 inline-block">
            ← トレーナー一覧に戻る
          </TrainerListBackLink>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
        <div className="bg-white border border-slate-200 shadow-sm rounded-lg p-6">
          <div className="text-slate-600 text-sm mb-1">担当会員数</div>
        ...
        <div className="bg-white border border-slate-200 shadow-sm rounded-lg p-6">
          <div className="text-slate-600 text-sm mb-1">継続率</div>
        ...
        >
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="text-right">
              <div className="text-slate-500 text-xs mb-1">期待効果</div>
          ...
          <div className="mt-6">
            <div className="text-slate-600 text-xs font-semibold mb-3">
              今やること
            </div>
      ...
      <div className="bg-white border border-slate-200 shadow-sm rounded-lg p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
            <div className="text-slate-600 text-xs mb-1">総合スコア</div>
            <div className="text-3xl font-bold text-slate-900">{trainerEvaluation.summaryScore}</div>
          </div>
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
            <div className="text-slate-600 text-xs mb-1">評価</div>
            <div
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
            <div className="text-slate-600 text-xs mb-1">30日 high 予測会員</div>
            <div className="text-2xl font-bold text-slate-800">
              {trainerEvaluation.metrics.highChurn30DaysMembers}人
            </div>
          </div>
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
            <div className="text-slate-600 text-xs mb-1">記録品質</div>
            <div className="text-2xl font-bold text-slate-800">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="bg-slate-50 border border-green-500/30 rounded-lg p-4">
            <h3 className="text-sm font-semibold text-green-300 mb-2">強み</h3>
            {trainerEvaluation.strengths.length === 0 ? (
              <p className="text-slate-500 text-xs">現時点では抽出中です</p>
            ) : (
              <ul className="space-y-2">
          ...
          <div className="bg-slate-50 border border-yellow-500/30 rounded-lg p-4">
            <h3 className="text-sm font-semibold text-yellow-300 mb-2">改善ポイント</h3>
            {trainerEvaluation.improvementPoints.length === 0 ? (
              <p className="text-slate-500 text-xs">大きな改善ポイントはありません</p>
            ) : (
              <ul className="space-y-2">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
            <h3 className="text-sm font-semibold text-slate-800 mb-2">今やること</h3>
            <ul className="space-y-2">
      ...
      <div className="bg-white border border-slate-200 shadow-sm rounded-lg p-6 mb-6">
        ...
        {membersList.length === 0 ? (
          <p className="text-slate-600 text-sm">担当会員はありません</p>
        ) : (
      ...
      <div className="bg-white border border-slate-200 shadow-sm rounded-lg p-6">
        ...
        {interventionTasks.length === 0 ? (
          <p className="text-slate-600 text-sm">介入タスクはありません</p>
        ) : (
          <div className="space-y-3 max-h-[600px] overflow-y-auto">
            {interventionTasks.map((item) => (
              <div
                key={item.task.id}
                className="bg-slate-50 border border-slate-200 rounded-lg p-4 hover:bg-slate-100/80 transition-colors"
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="flex-1">
                    <div className="font-semibold text-slate-900">
