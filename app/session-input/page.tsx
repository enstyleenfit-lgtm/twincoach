  ...
  useEffect(() => {
    const run = async () => {
      try {
        ...
        const ms: Member[] = res.ok ? await res.json() : [];
        setMembers(ms);
        setAssignedMembers(ms.filter((m) => m.assignedTrainer === TRAINER_NAME));
      } catch {
        setMembers([]);
        setAssignedMembers([]);
      }
    ...
    <div className="p-4 sm:p-6">
      <div className="max-w-3xl mx-auto">
        <header className="mb-4">
          <h1 className="text-2xl sm:text-3xl font-bold">セッション入力</h1>
          ...
          <div className="flex items-end gap-3">
            <div className="flex-1">
              ...
              <select
                ...
                className="w-full rounded-lg bg-zinc-950 border border-zinc-800 px-3 py-3 text-white"
              >
            ...
            <div className="shrink-0">
              <button
                ...
                className="h-12 px-4 rounded-lg border border-zinc-700 bg-black/30 text-zinc-200 text-sm font-semibold hover:bg-zinc-800 transition-colors"
              >
                前回コピー
              </button>
            </div>
          ...
          <div className="flex flex-wrap gap-2">
            {quickExercisesOptions.slice(0, 5).map((x) => (
              <button
                ...
                className="rounded-lg border border-zinc-700 bg-zinc-900 px-3 py-2 text-xs text-zinc-200 hover:bg-zinc-800 transition-colors"
              >
                {x}
              </button>
            ))}
                ...
                <div>
                  ...
                  {d.exerciseBase === "その他" && (
                    <input
                      ...
                      className="mt-2 w-full rounded-lg bg-zinc-950 border border-zinc-800 px-3 py-3 text-white placeholder:text-zinc-600"
                    />
                  )}
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full rounded-lg bg-zinc-950 border px-3 py-3 text-white ${
                  ...
                  {memoOpen[d.localId] ? (
                    <div>
                      <input
                        ...
                        className={`w-full rounded-lg bg-zinc-950 border px-3 py-3 text-white placeholder:text-zinc-600 ${
                          d.note.trim()
                            ? "border-emerald-500/40"
                            : "border-zinc-800"
                        }`}
        ...
        <div className="fixed left-0 right-0 bottom-0 p-4 sm:p-6 bg-black/70 backdrop-blur border-t border-zinc-800">
          <div className="max-w-3xl mx-auto">
